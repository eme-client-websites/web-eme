...
interface ClientesShowcaseProps {
  locale: Locale;
}

export default function ClientesShowcase({ locale }: ClientesShowcaseProps) {
  ...
  // Crear arrays triplicados para animación infinita
  const tripleGroup1 = [...clientesGroup1, ...clientesGroup1, ...clientesGroup1];
  const tripleGroup2 = [...clientesGroup2, ...clientesGroup2, ...clientesGroup2];
  const tripleGroup3 = [...clientesGroup3, ...clientesGroup3, ...clientesGroup3];

  return (
    <section className="py-20 lg:py-32 relative overflow-hidden" style={{ background: 'transparent' }}>
      {/* Efectos de luz de fondo */}
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#0043FF] rounded-full mix-blend-screen filter blur-3xl opacity-5"></div>
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#0033C4] rounded-full mix-blend-screen filter blur-3xl opacity-5"></div>
      ...
      <div className="container-custom relative z-10 mb-16">
        <div className="pt-4 xl:pt-6">
          <div className="flex flex-wrap justify-between xl:flex-nowrap xl:gap-x-[5rem]">
            <div className="w-full xl:w-auto -ml-4 xl:-ml-8">
      ...
      <div className="relative">
        ...
        <div className="clients-marquee mb-8">
          <div className="clients-track clients-track-right">
            {tripleGroup1.map((cliente, index) => (
              <div key={`group1-${index}`} className="client-logo-wrapper">
        ...
        <div className="clients-marquee mb-8">
          <div className="clients-track clients-track-left">
            {tripleGroup2.map((cliente, index) => (
              <div key={`group2-${index}`} className="client-logo-wrapper">
                <div className="client-logo-container">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img 
                    src={cliente.logo} 
        ...
        <div className="clients-marquee">
          <div className="clients-track clients-track-right-slow">
            {tripleGroup3.map((cliente, index) => (
              <div key={`group3-${index}`} className="client-logo-wrapper">
                <div className="client-logo-container">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img 
                    src={cliente.logo} 
